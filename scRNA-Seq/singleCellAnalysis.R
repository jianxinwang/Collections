...
count10x.minus.dox <- Read10X_h5("/mnt/scRNA/data/Yin/COUNT/RS-03901823_4T1-RBdCDKminusDox_RS-03900475_count/outs/filtered_feature_bc_matrix.h5")
count10x.plus.dox <- Read10X_h5("/mnt/scRNA/data/Yin/COUNT/RS-03901824_4T1-RBdCDKplusDox_RS-03900476_count/outs/filtered_feature_bc_matrix.h5")


sobj.m.dox <- CreateSeuratObject(counts = count10x.minus.dox, project = "RBdCDK")
sobj.p.dox <- CreateSeuratObject(counts = count10x.plus.dox, project = "RBdCDK")


sobjList <- list()
sobjList[['minusDox']] <- sobj.m.dox
sobjList[['plusDox']] <- sobj.p.dox
