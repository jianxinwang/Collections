...
metaDataMCF7_T47D <- read.csv("/mnt/Jason/scRNA/data/RS-03616030_ERpos-GEX_RS-03616038_ERpos-FB/metadata.txt", sep = "\t", row.names = 1)
metaDataHcc1806_MiaPaCa <- read.csv("/mnt/Jason/scRNA/data/RS-03616031_MiaHCC-GEX_RS-03616039_MiaHCC-FB/metadata.txt", sep = "\t", row.names = 1)

expDataMCF7_T47D <- Read10X(data.dir = "/mnt/Jason/scRNA/data/RS-03616030_ERpos-GEX_RS-03616038_ERpos-FB/")
expDataHCC1806_MiaPaCa <- Read10X(data.dir = "/mnt/Jason/scRNA/data/RS-03616031_MiaHCC-GEX_RS-03616039_MiaHCC-FB//")
...
setwd("/mnt/Jason/scRNA/output/test")
